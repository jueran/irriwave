...
public final class AppSharePreferenceMgr {
    /**
     * 保存在手机里面的SharedPreference的文件名称
     */
    public static final String FILE_NAME = "SHARE_PREFERENCE_COMMON";

    private AppSharePreferenceMgr() {
    }
    ...
    public static void putImage(Context context, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        AppSharePreferenceMgr.put(context, key, imgString);
    }
     ...
     * @param imageView
     */
    public static Bitmap getImage(Context context, String key, ImageView imageView) {
        String imgString = (String) AppSharePreferenceMgr.get(context, key, "");
