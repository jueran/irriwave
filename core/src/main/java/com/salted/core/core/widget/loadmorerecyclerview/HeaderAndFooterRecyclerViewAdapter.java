...
public class HeaderAndFooterRecyclerViewAdapter
            ...
            new RecyclerView.AdapterDataObserver() {
                ...
                public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
                    ...
                    notifyItemRangeChanged(
                            fromPosition + headerViewsCountCount,
     ...
     * @param adapter
     */
    private final void setAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        int headerViewsCountCount = getHeaderViewsCount();
        if (position >= headerViewsCountCount && position
                < headerViewsCountCount + mInnerAdapter.getItemCount()) {
        ...
        if (position < headerViewsCountCount) {
            ...
            if (innerItemViewType >= Integer.MAX_VALUE / 2) {
                throw new IllegalArgumentException(
                        "your adapter's return value of getViewTypeCount() "
                                + "must < Integer.MAX_VALUE / 2");
            }
