...
public final class DS {
    ...
    @NonNull
    public static List<String> toStringList(String sourceString) {
     ...
     */
    @NonNull
    public static List<String> toStringList(String sourceString, boolean nullable) {
        return toStringList(sourceString, nullable, DEFAULT_DIVIDER);
    }

    public static List<String> toStringList(String sourceString, String divider) {
       return toStringList(sourceString, false, divider);
    }

    public static List<String> toStringList(String sourceString, boolean nullable, String divider) {
    ...
    public static String listToString(final List<String> list, boolean nullable) {
        return listToString(list, nullable, DEFAULT_DIVIDER);
    }
    ...
    public static String listToString(final List<String> list, boolean nullable, String divider) {
        ...
        if (isEmpty(list, nullable)) return result.toString();

        for (String s : list) {
            result.append(s).append(divider);
        }

        return result.toString().substring(0, result.length() - divider.length());
    }
...
//        TagThrowableUtil.
// pushTagExceptionMessage(37572, TAG_DS + ":" + type + " (" + isDebug + ")"); // 老师端
//        TagThrowableUtil.
// pushTagExceptionMessage(41671, TAG_DS + ":" + type + " (" + isDebug + ")"); // 学生端
    }
