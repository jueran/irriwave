package com.irrigate.core.widget.tagview;
...
import static com.irrigate.core.widget.tagview.Utils.dp2px;
import static com.irrigate.core.widget.tagview.Utils.sp2px;
...
@SuppressWarnings("checkstyle:MagicMember")
public class TagContainerLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = attributes.getColor(
                ...
                mBackgroundColor);
        mDragEnable = attributes.getBoolean(
                R.styleable.AndroidTagView_container_enable_drag, false);
        ...
        mTagBackgroundColor = attributes.getColor(R.styleable.AndroidTagView_tag_background_color,
                mTagBackgroundColor);
        mTagTextColor = attributes.getColor(
                R.styleable.AndroidTagView_tag_text_color, mTagTextColor);
        mTagTextDirection = attributes.getInt(
                R.styleable.AndroidTagView_tag_text_direction, mTagTextDirection);
        ...
        mRippleAlpha = attributes.getInteger(
                R.styleable.AndroidTagView_tag_ripple_alpha, mRippleAlpha);
        mRippleDuration = attributes.getInteger(
                R.styleable.AndroidTagView_tag_ripple_duration, mRippleDuration);
        mEnableCross = attributes.getBoolean(
                R.styleable.AndroidTagView_tag_enable_cross, mEnableCross);
        mCrossAreaWidth = attributes.getDimension(R.styleable.AndroidTagView_tag_cross_width,
                dp2px(context, mCrossAreaWidth));
        mCrossAreaPadding = attributes.getDimension(
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    private int[] onUpdateColorFactory() {
        ...
        if (mTheme == ColorFactory.RANDOM) {
            ...
            colors = ColorFactory.onPureBuild(ColorFactory.PureColor.TEAL);
        } else if (mTheme == ColorFactory.PURE_CYAN) {
            colors = ColorFactory.onPureBuild(ColorFactory.PureColor.CYAN);
        } else {
    ...
    public void setOnTagsClickListener() {
//        for (View view : mChildViews) {
//            final TagView tagView = (TagView) view;
//            tagView.setOnTagClickListener(mOnTagClickListener);
//        }
